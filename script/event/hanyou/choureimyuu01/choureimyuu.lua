...
function hanyou_choureimyuu01_init()
end
function hanyou_choureimyuu01_start()
  ...
  WINDOW:Talk(SymAct("DENRYUU"), -1679227229)
  WINDOW:CloseMessage()
  ...
  CH("MYUU"):SetMotion(SymMot("LETSGO"), LOOP.OFF)
  WINDOW:SysMsg(-2098055198)
...
function hanyou_choureimyuu01_end()
end
function groundEnd()
end
