...
function hanyou_yuuhan01_init()
end
function hanyou_yuuhan01_start()
  ...
  WINDOW:SysMsg(-1734262033)
  WINDOW:ForceCloseMessage()
  WINDOW:SysMsg(-2118487122)
  WINDOW:ForceCloseMessage()
  WINDOW:SysMsg(-1432936339)
  WINDOW:ForceCloseMessage()
  WINDOW:SysMsg(-1282666196)
  WINDOW:ForceCloseMessage()
  WINDOW:SysMsg(-53639189)
  WINDOW:ForceCloseMessage()
  SOUND:FadeOutBgm(TimeSec(1))
  SOUND:FadeOutSe(SymSnd("SE_EVT_GATSUGATSU_LP"), TimeSec(0.5))
  SCREEN_A:FadeOut(TimeSec(0.5), true)
end
function hanyou_yuuhan01_end()
end
function groundEnd()
end
