...
function hanyou_yuuhanmyuu01_init()
end
function hanyou_yuuhanmyuu01_start()
  ...
  CH("MYUU"):SetManpu("EV_EAT_LP")
  CH("MYUU"):SetMotionRaito(Raito(2))
  CH("MYUU"):SetMotion(SymMot("SPEAK"), LOOP.ON)
  ...
  WINDOW:SysMsg(894979990)
  WINDOW:ForceCloseMessage()
  WINDOW:SysMsg(742620887)
  WINDOW:ForceCloseMessage()
  WINDOW:SysMsg(124661012)
  WINDOW:ForceCloseMessage()
  WINDOW:SysMsg(510991445)
  WINDOW:ForceCloseMessage()
  WINDOW:SysMsg(1362397842)
  WINDOW:ForceCloseMessage()
  SOUND:FadeOutBgm(TimeSec(1))
  SOUND:FadeOutSe(SymSnd("SE_EVT_GATSUGATSU_LP"), TimeSec(0.5))
  SCREEN_A:FadeOut(TimeSec(0.5), true)
end
function hanyou_yuuhanmyuu01_end()
end
function groundEnd()
end
